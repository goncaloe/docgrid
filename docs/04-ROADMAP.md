...
| 11 | IaC, CI/CD e AWS | Terraform escrito e não aplicado, GitHub Actions, imagem multi-arquitetura no ghcr.io | 2–3 sessões |
...
- **Fim da 11** — CI/CD a sério (testes, análise estática, segredos, imagem multi-arquitetura) e a infraestrutura AWS escrita e validada; sem conta AWS não há deploy nem URL público.
